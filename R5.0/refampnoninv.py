...
nc = ax.bus(pp.left(3.5).up(1), 'AVRG', align='top')
ax.connect((nc,  pp))

ng2 = ax.node(po.right(0.5))
r6l, r6r = ax.resistance_h(ng2.right(1), 'R6 1k', 'below')
ng3 = ax.node(r6r.right(0.5))
no = ax.bus(ng3.right(0.5).up(1.5), 'AREF', 'north')
