...
- The I2C bus pins are fixed (light purple).
...
| 3.3V           | VDD              | VCC1            |                 |               |              |                |
| GND            | GND              | GND1            |                 |               |              |                |
|                |                  |                 | External VCC2   | External VCC  | 1            | 1              |
|                |                  |                 | External GND2   | External GND  | 2            | 2              |
| (36) remove    | (CAN SHDN)       |                 |                 |               |              |                |
| (37) remove    | (CAN STB)        |                 |                 |               |              |                |
| 30             | CAN RX           | OUTA            | INA             | RXD           | 3 CANL       | 3 CANL         |
| 31             | CAN TX           | INA             | OUTA            | TXD           | 4 CANH       | 4 CANH         |
| 28 (was 40)    | I/O UP           | INB             | OUTB            |               | 5 I/O        |                |
| 29 (was 41)    | I/O DOWN         | OUTB            | INB             |               |              | 5 I/O          |
...
files, 6 DIP switches are connected to Teensy pins . Only while the
device ID is read in, 3.3V are supplied to the dip switches via Teensy
pin 14. The pull-down resistances have about 7kOhm. When a switch is
closed, this makes 0.5mA. Six switches closed makes in sum 3mA, which is
just below the maximum possible 4mA:

R0 - R5 = 7kOhm or 10kOhm
...
| GND               | GND              |
| 14                | Power to DIPs    |
| 41,40,37,36,35,34 | Device ID DIPs with pull-down 7k resistance  |

Alternative: [rotary DIP switch](https://www.mouser.de/datasheet/2/1628/rds_74385_smt-3510719.pdf)
...
- I2C: ERNI MiniBridge vertical male with 6 contacts (GND, 3.3V, SCL, SDA. LED, unused)
- SPI: ERNI MiniBridge vertical male with 6 contacts (GND, 3.3V, CS, SCK, MOSI, MISO)
- OneWire: 3 pins in 2.54mm spacing
