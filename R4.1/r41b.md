...
### Direct input on first channel

| Power     | boards | DC/DC | isolated | connected | gain | result           |
| :-------- | ------ | ----- | -------- | --------- | ---: | :--------------- |
| 12V       | one    | DC/DC | -        | -         | x100 | nice signal      |
| 12V       | two    | DC/DC | -        | -         | x100 | nice signal      |
| 12V       | one    | DC/DC | isolated | -         | x100 | nice signal      |
| 12V       | two    | DC/DC | isolated | -         | x100 | nice signal      |
| 12V       | one    | DC/DC | isolated | 1k        | x100 | nice signal      |

### Input on electrodes in water

| Power     | boards | DC/DC | isolated | connected | gain | result           |
| :-------- | ------ | ----- | -------- | --------- | ---: | :--------------- |
| Powerbank | one    | -     | -        | -         | x100 | good signal with few, small spikes |
| Powerbank | two    | -     | -        | -         | x100 | many noise spikes and ripples |
| Powerbank | two    | -     | -        | -         | x1   | ok, some noise spikes and ripples |
| 12V       | one    | DC/DC | -        | -         | x100 | ok, noisy        |
| 12V       | two    | DC/DC | -        | -         | x100 | super noisy, no signal |
| 12V       | one    | DC/DC | isolated | -         | x100 | zero line        |
| 12V       | one    | DC/DC | isolated | 1k        | x100 | zero line        |
| 12V       | one    | DC/DC | isolated | 100Ohm    | x100 | noisy signal     |
| 12V       | one    | DC/DC | isolated | 0Ohm      | x100 | noisy signal     |
| 12V       | two    | DC/DC | isolated | 100Ohm    | x100 | noisy signal     |
| 12V       | two    | DC/DC | isolated | 100Ohm    | x1   | slightly better noisy signal |
...
- SPI: vertical connector with 6 contacts (GND, 3.3V, CS, SCK, MOSI, MISO)
...
- Replace signal screw-terminals by connectors
