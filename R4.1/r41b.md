...
- Some means of detecting a device ID for setting a uniqe file name? DIP switches! Or silicon serial number https://www.analog.com/media/en/technical-documentation/data-sheets/ds2401.pdf . Or Rotary encoder switch / rotary DIP switch.
