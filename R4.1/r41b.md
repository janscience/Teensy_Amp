...
- The TDM bus pins (yellow and orange) are fixed (except for the GPIO lines).
- The I2C bus ins are fixed (light purple).
- The SPI bus pins are fixed (green).
- The CAN bus pins (pink, CRX and CTX) are fixed.
- All other pins can be moved or exchanged:
  - I/O UP, I/O DOWN (light pink)
  - Onewire data pin (pink)
  - Pushbuttom (cyan)
  - LED1 and LED2 (cyan)
  - DIP0 - DIP5 and 3.3V pin (dark purple)
...
- 4 channel digital isolator (2 forward, two reverse): [TI ISO6742 DW](https://www.ti.com/product/de-de/ISO6742).
...
- [TI isolators](https://www.ti.com/de-de/isolation/digital-isolators/overview.html)
...
For example, [TI TMP112](https://www.ti.com/product/de-de/TMP112) with
0.5C accuracy.
