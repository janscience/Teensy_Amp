...
files, for example, 5 DIP switches are connected to Teensy pins . Only
...
| GND            | GND              |
| 0              | Power to DIPs    |
| 1,2,6,7,9      | Device ID DIPs with pull-down 7k resistance  |
...
| GND            | GND              |
| 3.3V           | VDD              |
| 14             | OneWire data + 4.7kOhm to 3.3V |
| 24             | I2C2 SCL         |
| 25             | I2C2 SDA         |
| 10             | SPI CS           |
| 11             | SPI MOSI         |
