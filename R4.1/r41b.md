...
- Replace signal screw-terminals by dupont male pins (0.1" housing, right angle?)
...
- LED on board or on external PCB together with I2C.
- Add possibility of 6-bit dip switch for device identification.
